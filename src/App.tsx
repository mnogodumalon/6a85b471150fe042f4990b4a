...
const IntentAuftragErledigePage = lazy(() => import('@/pages/intents/AuftragErledigePage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/auftrag-erledigen" element={<Suspense fallback={null}><IntentAuftragErledigePage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
