...
import ServiceanfragePage from '@/pages/ServiceanfragePage';
import ServiceanfrageDetailPage from '@/pages/ServiceanfrageDetailPage';
...
const IntentAuftragAbliessenPage = lazy(() => import('@/pages/intents/AuftragAbliessenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="serviceanfrage" element={<ServiceanfragePage />} />
                <Route path="serviceanfrage/:id" element={<ServiceanfrageDetailPage />} />
                <Route path="auftragsverwaltung" element={<AuftragsverwaltungPage />} />
                <Route path="auftragsverwaltung/:id" element={<AuftragsverwaltungDetailPage />} />
                <Route path="admin" element={<AdminPage />} />
                <Route path="verwaltung/oeffentliche-seiten" element={<PublicPagesAdmin />} />
                {/* <custom:routes> */}
                <Route path="intents/anfrage-annehmen" element={<Suspense fallback={null}><IntentAnfrageAnnehmenPage /></Suspense>} />
                <Route path="intents/auftrag-abschliessen" element={<Suspense fallback={null}><IntentAuftragAbliessenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
