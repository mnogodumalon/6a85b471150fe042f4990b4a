 ...
 *   crud.enriched.serviceanfrage              // the display-ready array for EVERY entity —
...
export interface EntityCrud {
  ...
  enriched: { serviceanfrage: Serviceanfrage[]; auftragsverwaltung: EnrichedAuftragsverwaltung[] };
}
...
export function useEntityCrud(data: EntityCrudData, options?: EntityCrudOptions): EntityCrud {
  ...
  return {
    ...
    enriched: { serviceanfrage: data.serviceanfrage, auftragsverwaltung: enrichedAuftragsverwaltung },
  };
}
