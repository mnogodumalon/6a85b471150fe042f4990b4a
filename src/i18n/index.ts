...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "Elektro-Service",
    "apps": {
      "serviceanfrage": {
        "name": "Serviceanfrage",
        "app_id": "6a85b460cf17a31a72bcf59d",
        "fields": {
          ...
          "plz": "Postleitzahl",
          "ort": "Stadt / Ort",
          "einsatzort_geo": "Standort auf der Karte (optional)",
          "vorname": "Vorname",
          "nachname": "Nachname",
        ...
        "lookups": {
          "dringlichkeit": {
            "nicht_dringend": "Nicht dringend – kann warten",
            "normal": "Normal – innerhalb der nächsten Tage",
            "dringend": "Dringend – so bald wie möglich",
            "notfall": "Notfall – sofortiger Einsatz nötig"
          }
        }
      },
      "auftragsverwaltung": {
        "name": "Auftragsverwaltung",
        "app_id": "6a85b46412b8445c079128a7",
        "fields": {
          "anfrage": "Zugehörige Anfrage",
          "erledigt": "Erledigt",
    ...
    "apps": {
      "serviceanfrage": {
        ...
        "fields": {
          ...
          "plz": "Postal Code",
          "ort": "City / Town",
          "einsatzort_geo": "Location on Map (optional)",
          "vorname": "First Name",
          "nachname": "Last Name",
          "telefon": "Phone Number",
          "email": "Email Address",
          "erreichbarkeit": "Best Time to Reach"
        },
        "lookups": {
          "dringlichkeit": {
            "nicht_dringend": "Not Urgent – can wait",
            "normal": "Normal – within the next few days",
            "dringend": "Urgent – as soon as possible",
            "notfall": "Emergency – immediate deployment required"
          }
        }
      },
      "auftragsverwaltung": {
