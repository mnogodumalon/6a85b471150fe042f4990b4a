...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/anfrage-abschliessen', label: { de: 'Anfrage erledigen', en: 'Complete request' }, icon: IconCircleCheck, description: 'Anfrage als erledigt markieren und Auftrag anlegen oder aktualisieren' },
  // </custom:intents>
];
