...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/anfrage-abschliessen', label: { de: 'Anfrage abschließen', en: 'Close request' }, icon: IconCircleCheck, description: 'Offene Anfrage prüfen und als erledigt markieren' },
  // </custom:intents>
];
