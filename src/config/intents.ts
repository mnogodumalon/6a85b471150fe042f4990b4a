...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/anfrage-bearbeiten', label: { de: 'Anfrage bearbeiten', en: 'Process request' }, icon: IconClipboardCheck, description: 'Anfrage prüfen, Auftrag anlegen und als erledigt markieren' },
  // </custom:intents>
];
