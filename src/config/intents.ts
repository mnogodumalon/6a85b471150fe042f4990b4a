...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/anfrage-annehmen', label: { de: 'Anfrage annehmen', en: 'Accept request' }, icon: IconClipboardList, description: 'Offene Serviceanfrage als Auftrag anlegen' },
  { path: '/intents/auftrag-erledigen', label: { de: 'Auftrag erledigen', en: 'Complete job' }, icon: IconCircleCheck, description: 'Offenen Auftrag als erledigt markieren' },
  // </custom:intents>
];
