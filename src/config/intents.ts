...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/anfrage-abschliessen', label: { de: 'Anfrage abschließen', en: 'Complete request' }, icon: IconCircleCheck, description: 'Offene Serviceanfrage prüfen und als erledigt markieren' },
  // </custom:intents>
];
