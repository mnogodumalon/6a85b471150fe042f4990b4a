...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/anfrage-annehmen', label: { de: 'Anfrage annehmen', en: 'Accept request' }, icon: IconClipboardPlus, description: 'Neue Serviceanfrage manuell erfassen und Auftrag anlegen' },
  { path: '/intents/auftrag-abschliessen', label: { de: 'Auftrag abschließen', en: 'Complete job' }, icon: IconCircleCheck, description: 'Offenen Auftrag als erledigt markieren und Notizen eintragen' },
  // </custom:intents>
];
